...
module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c70 = function(l1, l2) { return ast.Tex.POCH(l1, l2); },
        peg$c71 = function(name, l) { return ast.Tex.PAREN2(name, l); },
        peg$c72 = function(r) { return ast.Tex.LITERAL(r); },
        peg$c73 = function(b, r) { return ast.Tex.BIG(b, r); },
        peg$c74 = function(b) { return ast.Tex.BIG(b, sq_close_ri); },
        peg$c75 = function(l, e, r) { return ast.Tex.LR(l, r, e.toArray()); },
        peg$c76 = function(name, e, l) { return ast.Tex.FUN2sq(name, ast.Tex.CURLY(e.toArray()), l); },
        peg$c77 = function(name, l) { return ast.Tex.FUN1(name, l); },
        peg$c78 = function(name, l) { return ast.Tex.FUN1nb(name, l); },
        peg$c79 = function(f, l) { return ast.Tex.FUN1hl(f[0], f[1], l); },
        peg$c80 = function(f, l) { return ast.Tex.FUN1hf(f[0], f[1], l); },
        peg$c81 = function(name, l1, l2) { return ast.Tex.FUN2(name, l1, l2); },
        peg$c82 = function(name, l1, l2) { return ast.Tex.FUN2nb(name, l1, l2); },
        peg$c83 = function(f, l1, l2) { return ast.Tex.FUN2h(f[0], f[1], l1, l2); },
        peg$c84 = function(name, l1, l2, l3) { return ast.Tex.FUN3(name, l1, l2, l3); },
        peg$c85 = function(e) { return ast.Tex.CURLY(e.toArray()); },
        peg$c86 = function(e1, name, e2) { return ast.Tex.INFIX(name, e1.toArray(), e2.toArray()); },
        peg$c87 = function(e1, f, e2) { return ast.Tex.INFIXh(f[0], f[1], e1.toArray(), e2.toArray()); },
        peg$c88 = function(m) { return ast.Tex.MATRIX("matrix", lst2arr(m)); },
        peg$c89 = function(m) { return ast.Tex.MATRIX("pmatrix", lst2arr(m)); },
        peg$c90 = function(m) { return ast.Tex.MATRIX("bmatrix", lst2arr(m)); },
        peg$c91 = function(m) { return ast.Tex.MATRIX("Bmatrix", lst2arr(m)); },
        peg$c92 = function(m) { return ast.Tex.MATRIX("vmatrix", lst2arr(m)); },
        peg$c93 = function(m) { return ast.Tex.MATRIX("Vmatrix", lst2arr(m)); },
        peg$c94 = function(m) { return ast.Tex.MATRIX("array", lst2arr(m)); },
        peg$c95 = function(m) { return ast.Tex.MATRIX("aligned", lst2arr(m)); },
        peg$c96 = function(m) { return ast.Tex.MATRIX("alignedat", lst2arr(m)); },
        peg$c97 = function(m) { return ast.Tex.MATRIX("smallmatrix", lst2arr(m)); },
        peg$c98 = function(m) { return ast.Tex.MATRIX("cases", lst2arr(m)); },
        peg$c99 = "\\begin{",
        peg$c100 = { type: "literal", value: "\\begin{", description: "\"\\\\begin{\"" },
        peg$c101 = function() { throw new SyntaxError("Illegal TeX function", [], text(), offset(), line(), column()); },
        peg$c102 = function(f) { return !tu.all_functions[f]; },
        peg$c103 = void 0,
        peg$c104 = function(f) { throw new SyntaxError("Illegal TeX function", [], f, offset(), line(), column()); },
        peg$c105 = function(l) { return ast.Tex.LITERAL(l); },
        ...
        peg$c115 = function(l, tail) { return { head: lst2arr(l), tail: tail }; },
        peg$c116 = function(f, l) { l.head.unshift(ast.Tex.LITERAL(ast.RenderT.TEX_ONLY(f + " "))); return l;},
        ...
        peg$c201 = function(f, c) { return ast.RenderT.TEX_ONLY("\\operatorname {" + f.slice(1) + "}" + c); },
        peg$c202 = function(f) { return tu.other_literals1[f]; },
        peg$c203 = function(f) { return ast.RenderT.TEX_ONLY(f + " "); },
        peg$c204 = function(f) { return tu.other_literals2[f]; },
        peg$c205 = function(f) { return ast.RenderT.TEX_ONLY("\\mbox{" + f + "} "); },
        peg$c206 = function(mbox) { return mbox === "\\mbox"; },
        peg$c207 = function(mbox, f) { return tu.other_literals2[f]; },
        peg$c208 = function(mbox, f) { return ast.RenderT.TEX_ONLY("\\mbox{" + f + "} "); },
        peg$c209 = function(f) { return tu.other_literals3[f]; },
        peg$c210 = function(f) { return ast.RenderT.TEX_ONLY(tu.other_literals3[f] + " "); },
        peg$c211 = function(f) { return ast.RenderT.TEX_ONLY(f); },
        peg$c212 = "\\",
        peg$c213 = { type: "literal", value: "\\", description: "\"\\\\\"" },
        peg$c214 = /^[, ;!_#%$&]/,
        peg$c215 = { type: "class", value: "[, ;!_#%$&]", description: "[, ;!_#%$&]" },
        peg$c216 = function(c) { return ast.RenderT.TEX_ONLY("\\" + c); },
        peg$c217 = /^[><~]/,
        peg$c218 = { type: "class", value: "[><~]", description: "[><~]" },
        peg$c219 = /^[%$]/,
        peg$c220 = { type: "class", value: "[%$]", description: "[%$]" },
        peg$c221 = function(c) { return ast.RenderT.TEX_ONLY("\\" + c); /* escape dangerous chars */},
        peg$c222 = function(f, c) { return ast.RenderT.TEX_ONLY("\\operatorname{" + f.slice(1) + "}" + c); },
        peg$c223 = /^[{}|]/,
        peg$c224 = { type: "class", value: "[{}|]", description: "[{}|]" },
        peg$c225 = function(f) { return tu.other_delimiters1[f]; },
        peg$c226 = function(f) { return tu.other_delimiters2[f]; },
        peg$c227 = function(f) { return ast.RenderT.TEX_ONLY(tu.other_delimiters2[f] + " "); },
        peg$c228 = function(c) { return ast.RenderT.TEX_ONLY(""); },
        peg$c229 = function(f) { return tu.fun_ar1nb[f]; },
        peg$c230 = function(f) { return f; },
        peg$c231 = function(f) { return tu.fun_ar1opt[f]; },
        peg$c232 = "&",
        peg$c233 = { type: "literal", value: "&", description: "\"&\"" },
        peg$c234 = "\\\\",
        peg$c235 = { type: "literal", value: "\\\\", description: "\"\\\\\\\\\"" },
        peg$c236 = "\\begin",
        peg$c237 = { type: "literal", value: "\\begin", description: "\"\\\\begin\"" },
        peg$c238 = "\\end",
        peg$c239 = { type: "literal", value: "\\end", description: "\"\\\\end\"" },
        peg$c240 = "{matrix}",
        peg$c241 = { type: "literal", value: "{matrix}", description: "\"{matrix}\"" },
        peg$c242 = "{pmatrix}",
        peg$c243 = { type: "literal", value: "{pmatrix}", description: "\"{pmatrix}\"" },
        peg$c244 = "{bmatrix}",
        peg$c245 = { type: "literal", value: "{bmatrix}", description: "\"{bmatrix}\"" },
        peg$c246 = "{Bmatrix}",
        peg$c247 = { type: "literal", value: "{Bmatrix}", description: "\"{Bmatrix}\"" },
        peg$c248 = "{vmatrix}",
        peg$c249 = { type: "literal", value: "{vmatrix}", description: "\"{vmatrix}\"" },
        peg$c250 = "{Vmatrix}",
        peg$c251 = { type: "literal", value: "{Vmatrix}", description: "\"{Vmatrix}\"" },
        peg$c252 = "{array}",
        peg$c253 = { type: "literal", value: "{array}", description: "\"{array}\"" },
        peg$c254 = "{align}",
        peg$c255 = { type: "literal", value: "{align}", description: "\"{align}\"" },
        peg$c256 = "{aligned}",
        peg$c257 = { type: "literal", value: "{aligned}", description: "\"{aligned}\"" },
        peg$c258 = "{alignat}",
        peg$c259 = { type: "literal", value: "{alignat}", description: "\"{alignat}\"" },
        peg$c260 = "{alignedat}",
        peg$c261 = { type: "literal", value: "{alignedat}", description: "\"{alignedat}\"" },
        peg$c262 = "{smallmatrix}",
        peg$c263 = { type: "literal", value: "{smallmatrix}", description: "\"{smallmatrix}\"" },
        peg$c264 = "{cases}",
        peg$c265 = { type: "literal", value: "{cases}", description: "\"{cases}\"" },
        peg$c266 = "\\big(",
        peg$c267 = { type: "literal", value: "\\big(", description: "\"\\\\big(\"" },
        peg$c268 = "\\Big(",
        peg$c269 = { type: "literal", value: "\\Big(", description: "\"\\\\Big(\"" },
        peg$c270 = "\\bigg(",
        peg$c271 = { type: "literal", value: "\\bigg(", description: "\"\\\\bigg(\"" },
        peg$c272 = "\\Bigg(",
        peg$c273 = { type: "literal", value: "\\Bigg(", description: "\"\\\\Bigg(\"" },
        peg$c274 = "\\bigl(",
        peg$c275 = { type: "literal", value: "\\bigl(", description: "\"\\\\bigl(\"" },
        peg$c276 = "\\Bigl(",
        peg$c277 = { type: "literal", value: "\\Bigl(", description: "\"\\\\Bigl(\"" },
        peg$c278 = "\\bigg1(",
        peg$c279 = { type: "literal", value: "\\bigg1(", description: "\"\\\\bigg1(\"" },
        peg$c280 = "\\Biggl(",
        peg$c281 = { type: "literal", value: "\\Biggl(", description: "\"\\\\Biggl(\"" },
        peg$c282 = "\\left(",
        peg$c283 = { type: "literal", value: "\\left(", description: "\"\\\\left(\"" },
        peg$c284 = ")",
        peg$c285 = { type: "literal", value: ")", description: "\")\"" },
        peg$c286 = "\\big)",
        peg$c287 = { type: "literal", value: "\\big)", description: "\"\\\\big)\"" },
        peg$c288 = "\\Big)",
        peg$c289 = { type: "literal", value: "\\Big)", description: "\"\\\\Big)\"" },
        peg$c290 = "\\bigg)",
        peg$c291 = { type: "literal", value: "\\bigg)", description: "\"\\\\bigg)\"" },
        peg$c292 = "\\Bigg)",
        peg$c293 = { type: "literal", value: "\\Bigg)", description: "\"\\\\Bigg)\"" },
        peg$c294 = "\\bigr)",
        peg$c295 = { type: "literal", value: "\\bigr)", description: "\"\\\\bigr)\"" },
        peg$c296 = "\\Bigr)",
        peg$c297 = { type: "literal", value: "\\Bigr)", description: "\"\\\\Bigr)\"" },
        peg$c298 = "\\biggr)",
        peg$c299 = { type: "literal", value: "\\biggr)", description: "\"\\\\biggr)\"" },
        peg$c300 = "\\Biggr)",
        peg$c301 = { type: "literal", value: "\\Biggr)", description: "\"\\\\Biggr)\"" },
        peg$c302 = "\\right)",
        peg$c303 = { type: "literal", value: "\\right)", description: "\"\\\\right)\"" },
        peg$c304 = "^",
        peg$c305 = { type: "literal", value: "^", description: "\"^\"" },
        peg$c306 = function(f) { return tu.big_literals[f]; },
        peg$c307 = function(f) { return tu.paren[f]; },
        peg$c308 = function(f) { return tu.fun_ar1[f]; },
        peg$c309 = function(f) { return tu.other_fun_ar1[f]; },
        peg$c310 = function(f) { return tu.fun_ar2[f]; },
        peg$c311 = function(f) { return tu.fun_ar3[f]; },
        peg$c312 = function(f) { return tu.fun_infix[f]; },
        peg$c313 = function(f) { return tu.declh_function[f]; },
        peg$c314 = function(f) { return ast.Tex.DECLh(f, ast.FontForce.RM(), []); /*see bug 54818*/ },
        peg$c315 = function(f) { return tu.fun_ar2nb[f]; },
        peg$c316 = function(f) { return tu.left_function[f]; },
        peg$c317 = function(f) { return tu.right_function[f]; },
        peg$c318 = function(f) { return tu.hline_function[f]; },
        peg$c319 = function(f) { return tu.color_function[f]; },
        peg$c320 = function(f, cs) { return f + " " + cs; },
        peg$c321 = function(f) { return tu.definecolor_function[f]; },
        peg$c322 = "named",
        peg$c323 = { type: "literal", value: "named", description: "\"named\"" },
        peg$c324 = function(cs) { return "{named}" + cs; },
        peg$c325 = "gray",
        peg$c326 = { type: "literal", value: "gray", description: "\"gray\"" },
        peg$c327 = function(cs) { return "{gray}" + cs; },
        peg$c328 = "rgb",
        peg$c329 = { type: "literal", value: "rgb", description: "\"rgb\"" },
        peg$c330 = function(cs) { return "{rgb}" + cs; },
        peg$c331 = "cmyk",
        peg$c332 = { type: "literal", value: "cmyk", description: "\"cmyk\"" },
        peg$c333 = function(cs) { return "{cmyk}" + cs; },
        peg$c334 = function(f, name, a) { return f + " {" + name.join('') + "}" + a; },
        peg$c335 = function(cs) { return "[named]" + cs; },
        peg$c336 = function(cs) { return "[gray]" + cs; },
        peg$c337 = function(cs) { return "[rgb]" + cs; },
        peg$c338 = function(cs) { return "[cmyk]" + cs; },
        peg$c339 = function(name) { return "{" + name.join('') + "}"; },
        peg$c340 = function(k) { return "{"+k+"}"; },
        peg$c341 = ",",
        peg$c342 = { type: "literal", value: ",", description: "\",\"" },
        peg$c343 = function(r, g, b) { return "{"+r+","+g+","+b+"}"; },
        peg$c344 = function(c, m, y, k) { return "{"+c+","+m+","+y+","+k+"}"; },
        peg$c345 = /^[01]/,
        peg$c346 = { type: "class", value: "[01]", description: "[01]" },
        peg$c347 = function() { return text().replace(/\s+$/g, ''); },
        peg$c348 = function() { return false; },
        peg$c349 = function() { return peg$currPos === input.length; },
