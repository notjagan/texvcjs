 ...
 * error is thrown stating that the declaration is invalid and also providing the declaration in question. The parameter
 * declaration contains the entire declaration string, while command is either "\newcommand" or "\renewcommand."
 */
function parseNewCommand(declaration, command, cmds) {
    ...
    switch (sections.length) {
        ...
        case 1:
            ...
            // \newcommand\command1{\replacement}
            if (definition.indexOf(cmd) === 0) {
                cmds[cmd] = sections[0][0];
            }
            // \newcommand{\replacement}\command2
            else {
        ...
        case 2:
            ...
            break;
        default:
            throw "Invalid new command declaration " + declaration + ".";
    }
}
