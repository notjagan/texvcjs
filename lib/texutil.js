...
try{ //try catch to make sure program still runs without csv file
    ...
    while (c < cmds.length) {
        ...
        /*if (cmds[c].type === 'latex_function_names') {
            latex_function_names.push(cmds[c].command);
        }*/
        c++;
    }
    //module.exports.latex_function_names = arr2set(latex_function_names);
