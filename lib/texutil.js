...
function parseSpecFun(text) {
    ...
    for (var r = 4 + i; r < sections.length; r++) {
        ...
        code += " { return ast.Tex." + command + "(";
    }
}

function parseSty(sty) {
...
//console.log(parseSty("texvc.sty"));
...
//    var pegJSCode = [];
    module.exports.other_literals3 = parseSty("texvc.sty");
//    console.log(pegJSCode);
