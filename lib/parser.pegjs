...
lit
  =
    f:PAREN atsymbol atsymbol l:lit &{ return options.semanticLaTeX; }     { return ast.Tex.PAREN2(f, l); }
  / f:PAREN atsymbol l:lit &{ return options.semanticLaTeX; } { return ast.Tex.PAREN1(f, l); }
  / l1:litparen1 "_" l2:lit  &{ return options.semanticLaTeX; }       { return ast.Tex.POCH(l1, l2); }
  / f:PAREN l:litparen1  &{ return options.semanticLaTeX; }       { return ast.Tex.PAREN1(f, l); } //must be before LITERAL!!
  / name:PAREN l:lit   &{ return options.semanticLaTeX; }         { return ast.Tex.PAREN2(name, l); }
